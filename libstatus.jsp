...
<!-- container begins-->
 <div class="container">
      ...
      <!-- head bottom begins-->
        <div class="headbottom">
           <!-- menu begins-->
            <div class="menu">
               <ul id="nav">
                   <li><a href="libhome.html">Back to panel</a>
              </li>
   ...
   <!-- header ends-->
    <!-- content begins-->
    <form action="libstachange.jsp" method="post" name="form">
    <center>
...
<tr>
    ...
    <td><input type="checkbox" name="employee" value="<%= rs.getString("book_name") %>"></td>
</tr>
<%
}
%>
